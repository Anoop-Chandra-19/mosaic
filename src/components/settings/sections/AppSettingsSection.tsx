      ...
      <article className="rounded-xl border border-zinc-300 bg-zinc-100 p-4 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <Button
            ...
            variant="outline"
            className={cn(
              'border-zinc-300 bg-background text-zinc-800 dark:border-zinc-600 dark:text-zinc-100',
              !darkMode &&
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? 'border-amber-500 bg-amber-100 text-zinc-900 dark:bg-zinc-800 dark:text-zinc-100'
                    : 'border-zinc-300 bg-background text-zinc-700 hover:bg-zinc-200 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800'
                )}
              >
